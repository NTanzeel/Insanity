...
public final class SpotAnim {
    ...
    public static void unpackConfig(StreamLoader streamLoader) {
        ...
        try {
            //stream = new rs2.Stream(streamLoader.getBytesFromFile(new File("test.dat")));
        } catch (Exception ioe) {
        }
        //rs2.Stream stream = new rs2.Stream
        ...
        for (int j = 0; j < length; j++) {
            ...
            cache[j].anInt404 = j;
            if (j < 666) cache[j].readValues(stream);
            else setGFXBase(j);
            ...
            if (j == 1190) {
                cache[j].anInt405 = 28240;// rs2.Model
                cache[j].anInt406 = 6957; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1198) {
                cache[j].anInt405 = 28176;// rs2.Model
                cache[j].anInt406 = 6970; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1197) {
                cache[j].anInt405 = 28177;// rs2.Model
                cache[j].anInt406 = 6970; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1203) {
                cache[j].anInt405 = 28202;// rs2.Model
                cache[j].anInt406 = 7025; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1206) {
                cache[j].anInt405 = 28218;// rs2.Model
                cache[j].anInt406 = 7030; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1207) {
                cache[j].anInt405 = 28219;// rs2.Model
                cache[j].anInt406 = 7031; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1165) {
                cache[j].anInt405 = 26597;// rs2.Model
                cache[j].anInt406 = 6697; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1166) {
                cache[j].anInt405 = 26595;// rs2.Model
                cache[j].anInt406 = 6698; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 678) {
                cache[j].anInt405 = 12734;// rs2.Model
                cache[j].anInt406 = 4072; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1103) {
                cache[j].anInt405 = 26393;// rs2.Model
            ...
            if (j == 1106) {
                cache[j].anInt405 = 26293;// rs2.Model
                cache[j].anInt406 = 366; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1107) {
            ...
            if (j == 1111) {
                cache[j].anInt405 = 26294;// rs2.Model
                cache[j].anInt406 = 366; // animation
                cache[j].aAnimation_407 = Animation.anims[cache[j].anInt406];// Update
            }
            if (j == 1124) {
                cache[j].anInt405 = 26598;// rs2.Model
