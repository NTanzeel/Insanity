    ...
    public static void method368(StreamLoader streamLoader) {
        ...
        for (int j = 0; j < 50; j++)
            try {
                ...
                if (lowMem && aBackgroundArray1474s[j].anInt1456 == 128) aBackgroundArray1474s[j].method356();
        ...
        for (int l = 0; l < 50; l++)
            if (aBackgroundArray1474s[l] != null) {
                ...
                for (int j1 = 0; j1 < ai.length; j1++) {
                    ...
                    if ((anIntArrayArray1483[l][j1] & 0xf8f8ff) == 0 && j1 != 0) anIntArrayArray1483[l][j1] = 1;
                }
            }
        ...
        if (aBoolean1464) {
            ...
            if (anInt1465 == 0) {
                ...
                if (k > 0) {
                    j = anIntArray1482[j1 >> 8];
                    j = ((j & 0xff00ff) * l2 >> 8 & 0xff00ff) + ((j & 0xff00) * l2 >> 8 & 0xff00);
                    do ai[i++] = j + ((ai[i] & 0xff00ff) * j2 >> 8 & 0xff00ff) + ((ai[i] & 0xff00) * j2 >> 8 & 0xff00);
                    while (--k > 0);
                }
            }
            return;
