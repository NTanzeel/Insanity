...
public final class Model extends Animable {
        ...
        for (int i1 = 0; i1 < i; i1++) {
            ...
            if (model_1 != null) {
                for (int j1 = 0; j1 < model_1.anInt1630; j1++) {
                    if (flag) if (model_1.anIntArray1637 == null) {
                    ...
                    if (flag1) if (model_1.anIntArray1638 == null) anIntArray1638[anInt1630] = model_1.anInt1641;
                    else anIntArray1638[anInt1630] = model_1.anIntArray1638[j1];
                    if (flag2) if (model_1.anIntArray1639 == null) anIntArray1639[anInt1630] = 0;
                    else anIntArray1639[anInt1630] = model_1.anIntArray1639[j1];
                    if (flag3 && model_1.anIntArray1656 != null) anIntArray1656[anInt1630] = model_1.anIntArray1656[j1];
        ...
        for (int j1 = 0; j1 < i; j1++) {
            ...
            if (model_1 != null) {
                ...
                for (int i2 = 0; i2 < model_1.anInt1630; i2++) {
                    ...
                    if (flag1) if (model_1.anIntArray1637 == null) {
                        anIntArray1637[anInt1630] = 0;
                    } else {
                    ...
                    if (flag2) if (model_1.anIntArray1638 == null) anIntArray1638[anInt1630] = model_1.anInt1641;
                    else anIntArray1638[anInt1630] = model_1.anIntArray1638[i2];
                    if (flag3) if (model_1.anIntArray1639 == null) anIntArray1639[anInt1630] = 0;
                    else anIntArray1639[anInt1630] = model_1.anIntArray1639[i2];
                    if (flag4 && model_1.anIntArray1640 != null) anIntArray1640[anInt1630] = model_1.anIntArray1640[i2];
                    anInt1630++;
                }
    ...
    private static byte[] getModel(int Index) {
        try {
            ...
            if (aByte != null && aByte.length > 0) {
                ...
                System.out.println("Unable To Find rs2.Model " + Index);
                return null;
            }
        } catch (Exception e) {
            System.out.println("Error Reading rs2.Model");
            return null;
        }
    }
    ...
    private int method465(Model model, int i) {
        ...
        for (int j1 = 0; j1 < anInt1626; j1++) {
            if (k != anIntArray1627[j1] || l != anIntArray1628[j1] || i1 != anIntArray1629[j1]) continue;
            j = j1;
            break;
        }
        if (j == -1) {
    ...
    public void method476(int i, int j) {
        for (int k = 0; k < anInt1630; k++)
            if (anIntArray1640[k] == i) anIntArray1640[k] = j;
    }
    ...
    public void method480(int i, int j, int k, int l, int i1) {
        ...
        if (anIntArray1637 != null) {
            for (int l1 = 0; l1 < anInt1630; l1++)
                if ((anIntArray1637[l1] & 2) == 2) return;
        }
        anIntArray1640 = null;
    }
    ...
    public void method443(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
        ...
        if (i2 > 0 && aBoolean1684) {
            ...
            if (i6 > k3 && i6 < l3 && k6 > i5 && k6 < k4) if (aBoolean1659) anIntArray1688[anInt1687++] = i2;
            else flag1 = true;
        }
    ...
    private void method485(int i) {
        ...
        if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
            ...
            if (l == 3) {
                ...
                else if (l7 == 1) Texture.method376(i7, j7, k7, j3, j4, j5, modelIntArray3[anIntArray1634[i]]);
                else if (l7 == 2) {
