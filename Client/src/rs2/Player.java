...
public final class Player extends Entity {
    ...
    public Model method452() {
        if (desc != null) {
            int j = -1;
            if (super.anim >= 0 && super.anInt1529 == 0) j = Animation.anims[super.anim].anIntArray353[super.anInt1527];
            else if (super.anInt1517 >= 0) j = Animation.anims[super.anInt1517].anIntArray353[super.anInt1518];
        ...
        } else if (super.anInt1517 >= 0) k = Animation.anims[super.anInt1517].anIntArray353[super.anInt1518];
        ...
        if (k != -1 && i1 != -1) model_2.method471(Animation.anims[super.anim].anIntArray357, i1, k);
