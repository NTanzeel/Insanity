...
final class StreamLoader {
    ...
    public byte[] getDataForName(String s) {
        ...
        if (s.equalsIgnoreCase("rs2.NPC.DAT") || s.equalsIgnoreCase("rs2.NPC.IDX")) System.out.println(s + " : " + i);
        ...
        for (int k = 0; k < dataSize; k++)
            if (anIntArray728[k] == i) {
                ...
                if (!aBoolean732) {
                    ...
                    if (s.equalsIgnoreCase("rs2.NPC.DAT") || s.equalsIgnoreCase("rs2.NPC.IDX"))
