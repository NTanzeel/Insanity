...
public class client extends RSApplet {
    ...
    private static String intToKOrMilLongName(int i) {
        ...
        if (s.length() > 8) s = "@gre@" + s.substring(0, s.length() - 8) + " million @whi@(" + s + ")";
    ...
    public void models() {
        for (int ModelIndex = 0; ModelIndex < 29191; ModelIndex++) {
            ...
            if (abyte0 != null && abyte0.length > 0) {
                ...
                pushMessage("rs2.Model added successfully!", 0, "");
            }
        }
    }
            ...
            for (int k = 0; k < 500; k++)
                if (chatMessages[k] != null) {
                    ...
                    if (chatType == 5 && splitPrivateChat == 0 && privateChatMode < 2) {
                        if (chatTypeView == 2 || chatTypeView == 0) {
                            if (yPos > 0 && yPos < 210) textDrawingArea.method385(0x800000, chatMessages[k], yPos, 11);
                            j++;
                            j77++;
                        }
                    }
                    ...
                    if (chatType == 16) {
                        ...
                        if (chatTypeView == 11 || chatTypeView == 0) {
                            if (yPos > 3 && yPos < 130) switch (chatRights[k]) {
                                case 1:
                                    j2 += clanNameWidth;
    ...
    private void method24(int i) {
        ...
        for (int l = 1; l < 103; l++) {
            ...
            for (int k1 = 1; k1 < 103; k1++) {
                ...
                if (i < 3 && (byteGroundArray[i + 1][k1][l] & 8) != 0) worldController.method309(ai, i1, i + 1, k1, l);
                i1 += 4;
            }
        }
...
//	notifyItemSpawn(item, i + baseX, j + baseY);
    ...
    private void buildInterfaceMenu(int i, RSInterface class9, int k, int l, int i1, int j1) {
        if (class9.type != 0 || class9.children == null || class9.isMouseoverTriggered) return;
        ...
        for (int l1 = 0; l1 < k1; l1++) {
            ...
            if ((class9_1.mOverInterToTrigger >= 0 || class9_1.anInt216 != 0) && k >= i2 && i1 >= j2 && k < i2 + class9_1.width && i1 < j2 + class9_1.height)
                if (class9_1.mOverInterToTrigger >= 0) anInt886 = class9_1.mOverInterToTrigger;
    ...
    private void drawTabArea() {
        ...
        if (invOverlayInterfaceID != -1) drawInterface(0, 28, RSInterface.interfaceCache[invOverlayInterfaceID], 37);
    ...
    private void drawMenu() {
        ...
        int l = menuHeight + 1;
        int i1 = 0x5d5447;
        //rs2.DrawingArea.drawPixels(height, yPos, xPos, color, width);
        //rs2.DrawingArea.fillPixels(xPos, width, height, color, yPos);
    ...
    private void method45() {
        ...
        for (int j = 0; j < 7; j++) {
            ...
            for (int k = 0; k < IDK.length; k++) {
                if (IDK.cache[k].aBoolean662 || IDK.cache[k].anInt657 != j + (aBoolean1047 ? 0 : 7)) continue;
                anIntArray1065[j] = k;
                break;
            }
        }
    ...
    private void processOnDemandQueue() {
        do {
            ...
            do {
                ...
                if (onDemandData.dataType == 1 && onDemandData.buffer != null) Class36.method529(onDemandData.buffer);
    ...
    private void drawHeadIcon() {
        ...
        if (spriteDrawX > -1 && loopCycle % 20 < 10) headIconsHint[0].drawSprite(spriteDrawX - 12, spriteDrawY - 28);
    }
            ...
            if (super.clickMode2 == 0) {
                ...
                if (aBoolean1242 && anInt989 >= 5) {
                    ...
                    if (lastActiveInvInterface == anInt1084 && mouseInvInterfaceIndex != anInt1085) {
                        ...
                        int j1 = 0;
                        if (anInt913 == 1 && class9.contentType == 206) j1 = 1;
    ...
    private StreamLoader streamLoaderForName(int i, String s, String s1, int j, int k) {
        ...
        while (abyte0 == null) {
            ...
            try {
                ...
                datainputstream.close();
                try {
                    if (decompressors[0] != null) decompressors[0].method234(abyte0.length, abyte0, i);
                } catch (Exception _ex) {
  ...
  */
    ...
    private void doAction(int i) {
        ...
        if (l == 234) {
            ...
            if (!flag1) flag1 = doWalkTo(2, 0, 1, 0, myPlayer.smallY[0], 1, 0, k, myPlayer.smallX[0], false, j);
            crossX = super.saveClickX;
            crossY = super.saveClickY;
            crossType = 2;
            crossIndex = 0;
        ...
        if (l == 511) {
            ...
            if (!flag2) flag2 = doWalkTo(2, 0, 1, 0, myPlayer.smallY[0], 1, 0, k, myPlayer.smallX[0], false, j);
            crossX = super.saveClickX;
            crossY = super.saveClickY;
            crossType = 2;
            crossIndex = 0;
        ...
        if (l == 74) {
            ...
            if (RSInterface.interfaceCache[k].parentID == openInterfaceID) atInventoryInterfaceType = 1;
            if (RSInterface.interfaceCache[k].parentID == backDialogID) atInventoryInterfaceType = 3;
        }
        if (l == 315) {
            RSInterface class9 = RSInterface.interfaceCache[k];
            boolean flag8 = true;
            if (class9.contentType > 0) flag8 = promptUserForInput(class9);
            if (flag8) {
        ...
        if (l == 516) if (!menuOpen) worldController.method312(super.saveClickY - 4, super.saveClickX - 4);
        ...
        if (l == 626) {
            ...
            //System.out.println("rs2.Sprite: " + class9_1.sprite1.toString());
            if (spellUsableOn == 16) {
                needDrawTabArea = true;
                tabID = 3;
                tabAreaAltered = true;
        ...
        if (l == 213) {
            ...
            if (!flag3) flag3 = doWalkTo(2, 0, 1, 0, myPlayer.smallY[0], 1, 0, k, myPlayer.smallX[0], false, j);
            crossX = super.saveClickX;
            crossY = super.saveClickY;
            crossType = 2;
            crossIndex = 0;
        ...
        if (l == 652) {
            ...
            if (!flag4) flag4 = doWalkTo(2, 0, 1, 0, myPlayer.smallY[0], 1, 0, k, myPlayer.smallX[0], false, j);
            crossX = super.saveClickX;
            crossY = super.saveClickY;
            crossType = 2;
            crossIndex = 0;
        ...
        if (l == 94) {
            ...
            if (!flag5) flag5 = doWalkTo(2, 0, 1, 0, myPlayer.smallY[0], 1, 0, k, myPlayer.smallX[0], false, j);
            crossX = super.saveClickX;
            crossY = super.saveClickY;
            crossType = 2;
            crossIndex = 0;
        ...
        if (l == 567) {
            ...
            if (!flag6) flag6 = doWalkTo(2, 0, 1, 0, myPlayer.smallY[0], 1, 0, k, myPlayer.smallX[0], false, j);
            crossX = super.saveClickX;
            crossY = super.saveClickY;
            crossType = 2;
            crossIndex = 0;
        ...
        if (l == 244) {
            ...
            if (!flag7) flag7 = doWalkTo(2, 0, 1, 0, myPlayer.smallY[0], 1, 0, k, myPlayer.smallX[0], false, j);
            crossX = super.saveClickX;
            crossY = super.saveClickY;
            crossType = 2;
            crossIndex = 0;
            ...
            if (openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
                ...
                if (j == 13 || j == 10) {
                    ...
                    if (friendsListAction == 3 && promptInput.length() > 0) {
                        ...
                        //promptInput = rs2.Censor.doCensor(promptInput);
                ...
                if ((j == 13 || j == 10) && inputString.length() > 0) {
                    if (myPrivilege == 2 || server.equals("127.0.0.1") || 1 == 1/*to remove*/) {
                        ...
                        if (inputString.equals("dumpnpcs")) EntityDef.rewriteNpcs();
                        ...
                        if (inputString.equals("::dataon")) clientData = true;
                        if (inputString.equals("::dataoff")) clientData = false;
                    ...
                    if (inputString.startsWith("/")) inputString = "::" + inputString;
                    if (inputString.equals("add model")) {
                        try {
                            int ModelIndex = Integer.parseInt(JOptionPane.showInputDialog(this, "Enter model ID", "rs2.Model", 3));
                            byte[] abyte0 = getModel(ModelIndex);
                            if (abyte0 != null && abyte0.length > 0) {
                                decompressors[1].method234(abyte0.length, abyte0, ModelIndex);
                                pushMessage("rs2.Model: [" + ModelIndex + "] added successfully!", 0, "");
                            } else {
                    ...
                    if (inputString.startsWith("::")) {
                        ...
                        //inputString = rs2.Censor.doCensor(inputString);
                        myPlayer.textSpoken = inputString;
                        myPlayer.anInt1513 = j2;
                        myPlayer.anInt1531 = i3;
                        myPlayer.textCycle = 150;
                        if (myPrivilege == 2) pushMessage(myPlayer.textSpoken, 2, "@cr2@" + myPlayer.name);
    ...
    private void drawFriendsListOrWelcomeScreen(RSInterface class9) {
        ...
        if (j >= 101 && j <= 200 || j >= 801 && j <= 900) {
            ...
            else if (friendsNodeIDs[j] == nodeID) class9.message = "@gre@Online"/* + (friendsNodeIDs[j] - 9)*/;
            ...
            if (aBoolean1031) {
                ...
                for (int l2 = 0; l2 < 5; l2++)
                    if (anIntArray990[l2] != 0) {
                        ...
                        if (l2 == 1) characterDisplay.method476(anIntArray1204[0], anIntArray1204[anIntArray990[l2]]);
                    }
        ...
        if (j == 652) if (daysSinceRecovChange == 201) {
            if (membersInt == 1) class9.message = "@yel@This is a non-members world: @whi@Since you are a member we";
            else class9.message = "";
        ...
        if (j == 653) if (daysSinceRecovChange == 201) {
            if (membersInt == 1) class9.message = "@whi@recommend you use a members world instead. You may use";
            else class9.message = "";
        } else if (daysSinceRecovChange == 200)
        ...
        if (j == 654) {
            if (daysSinceRecovChange == 201) if (membersInt == 1) {
...
//	entityMessage(npc);
            ...
            for (int l = 4; l >= 0; l--)
                if (atPlayerActions[l] != null) {
                    ...
                    if (atPlayerActions[l].equalsIgnoreCase("attack")) {
                        ...
                        if (myPlayer.team != 0 && player.team != 0) if (myPlayer.team == player.team) c = '\u07D0';
                        else c = '\0';
    ...
    private void method99(Entity entity) {
        ...
        entity.anInt1517 = j1;
        int k1 = 4;
        if (entity.anInt1552 != entity.turnDirection && entity.interactingEntity == -1 && entity.anInt1504 != 0) k1 = 2;
    ...
    private void method100(Entity entity) {
        ...
        if (entity.interactingEntity != -1 && entity.interactingEntity < 32768) {
            ...
            if (npc != null) {
                ...
                if (i1 != 0 || k1 != 0) entity.turnDirection = (int) (Math.atan2(i1, k1) * 325.94900000000001D) & 0x7ff;
            }
        }
        if (entity.interactingEntity >= 32768) {
            ...
            if (player != null) {
                ...
                if (l1 != 0 || i2 != 0) entity.turnDirection = (int) (Math.atan2(l1, i2) * 325.94900000000001D) & 0x7ff;
            }
        }
        ...
        if (l != 0) {
            if (l < entity.anInt1504 || l > 2048 - entity.anInt1504) entity.anInt1552 = entity.turnDirection;
        ...
        for (int j2 = 0; j2 < i2; j2++) {
            ...
            for (int m5 = 0; m5 < IDs.length; m5++) {
                if (class9_1.id == IDs[m5] + 1) {
                    if (m5 > 61) drawBlackBox(k2 + 1, l2);
                    else drawBlackBox(k2, l2 + 1);
                }
            }
            ...
            if (class9_1.type == 0) {
            ...
            } else if (class9_1.type != 1) if (class9_1.type == 2) {
                int i3 = 0;
                    ...
                    for (int l4 = 0; l4 < class9_1.width; l4++) {
                        ...
                        if (class9_1.inv[i3] > 0) {
                            ...
                            if (k5 > DrawingArea.topX - 32 && k5 < DrawingArea.bottomX && j6 > DrawingArea.topY - 32 && j6 < DrawingArea.bottomY || activeInterfaceType != 0 && anInt1085 == i3) {
                                int l9 = 0;
                                if (itemSelected == 1 && anInt1283 == i3 && anInt1284 == class9_1.id) l9 = 0xffffff;
                ...
                boolean flag = false;
                if (anInt1039 == class9_1.id || anInt1048 == class9_1.id || anInt1026 == class9_1.id) flag = true;
                int j3;
                ...
                if (class9_1.aByte254 == 0) {
                    if (class9_1.aBoolean227) DrawingArea.drawPixels(class9_1.height, l2, k2, j3, class9_1.width);
                ...
                boolean flag1 = false;
                if (anInt1039 == class9_1.id || anInt1048 == class9_1.id || anInt1026 == class9_1.id) flag1 = true;
                int i4;
                if (interfaceIsSelected(class9_1)) {
                ...
                if (model != null) model.method482(class9_1.modelRotation2, 0, class9_1.modelRotation1, 0, i5, l5);
                ...
                for (int j5 = 0; j5 < class9_1.height; j5++) {
                    for (int i6 = 0; i6 < class9_1.width; i6++) {
                        if (class9_1.inv[k4] > 0) {
                            ...
                            else textDrawingArea_1.method389(class9_1.textShadow, i9, class9_1.textColor, s2, k9);
                        }
                        k4++;
                    }
                }
    ...
    private void draw3dScreen() {
        ...
        if (anInt1055 == 1) multiOverlay.drawSprite(472, 296);
        if (fpsOn) {
            char c = '\u01FB';
            int k = 20;
            int i1 = 0xffff00;
        ...
        if (anInt1104 != 0) {
            ...
            int l = j / 60;
            j %= 60;
            if (j < 10) aTextDrawingArea_1271.method385(0xffff00, "System update in: " + l + ":0" + j, 329, 4);
    ...
    private void determineMenuSize() {
        ...
        if (super.saveClickX > 519 && super.saveClickY > 168 && super.saveClickX < 765 && super.saveClickY < 503) {
            ...
            if (j1 < 0) j1 = 0;
            else if (j1 + i > 245) j1 = 245 - i;
            int i2 = super.saveClickY - 168;
            if (i2 < 0) i2 = 0;
            else if (i2 + l > 333) i2 = 333 - l;
            menuOpen = true;
            menuScreenArea = 1;
            menuOffsetX = j1;
            menuOffsetY = i2;
        ...
        if (super.saveClickX > 0 && super.saveClickY > 338 && super.saveClickX < 516 && super.saveClickY < 503) {
            ...
            if (k1 < 0) k1 = 0;
            else if (k1 + i > 516) k1 = 516 - i;
            int j2 = super.saveClickY - 338;
            if (j2 < 0) j2 = 0;
            else if (j2 + l > 165) j2 = 165 - l;
            menuOpen = true;
            menuScreenArea = 2;
            menuOffsetX = k1;
            menuOffsetY = j2;
                ...
                if (l != -1) {
                    ...
                    for (class9_1.anInt208 += i; class9_1.anInt208 > animation.method258(class9_1.anInt246); ) {
                        ...
                        if (class9_1.anInt246 >= animation.anInt352) {
                            ...
                            if (class9_1.anInt246 < 0 || class9_1.anInt246 >= animation.anInt352) class9_1.anInt246 = 0;
                        }
                        flag1 = true;
                    }
                }
    ...
    private int method121() {
        ...
        if (j - zCameraPos < 800 && (byteGroundArray[plane][xCameraPos >> 7][yCameraPos >> 7] & 4) != 0) return plane;
        else return 3;
    }
        ...
        for (int j6 = 0; j6 < playerCount; j6++) {
            ...
            if (player != null && player.isVisible()) {
                ...
                for (int j3 = 0; j3 < clanList.length; j3++) {
                    ...
                    if (!clanList[j3].equalsIgnoreCase(player.name)) continue;
                    flag3 = true;
                    break;
                }
                ...
                else if (flag3) markMinimap(mapDotClan, j1, l3);
    ...
    private void doFlamesDrawing() {
        ...
        if (anInt1040 > 0) {
            for (int i = 0; i < 256; i++)
                if (anInt1040 > 768) anIntArray850[i] = method83(anIntArray851[i], anIntArray852[i], 1024 - anInt1040);
                else if (anInt1040 > 256) anIntArray850[i] = anIntArray852[i];
                else anIntArray850[i] = method83(anIntArray852[i], anIntArray851[i], 256 - anInt1040);
        } else if (anInt1041 > 0) {
            for (int j = 0; j < 256; j++)
                if (anInt1041 > 768) anIntArray850[j] = method83(anIntArray851[j], anIntArray853[j], 1024 - anInt1041);
                else if (anInt1041 > 256) anIntArray850[j] = anIntArray853[j];
                else anIntArray850[j] = method83(anIntArray853[j], anIntArray851[j], 256 - anInt1041);
        } else {
            ...
            case 169:
                ...
                switch (button) {
                    case 19136:
                        ...
                        if (toggle == 0) sendFrame36(173, toggle);
                        if (toggle == 1) sendPacket185(153, 173, 646);
                        break;
                }
                break;
        }
            ...
            switch (pktType) {
                ...
                case 217:
                    try {
                        ...
                        //message = rs2.TextInput.processText(message);
                        //message = rs2.Censor.doCensor(message);
                ...
                case 196:
                    ...
                    if (!flag5 && anInt1251 == 0) try {
                        ...
                        else if (l21 == 1) pushMessage(s9, 7, "@cr1@" + TextClass.fixName(TextClass.nameForLong(l5)));
