...
final class Class6 {
    ...
    public int[] method167(int i, int j) {
        ...
        if (aClass29_104 != null) {
            ...
            for (int i7 = 0; i7 < i; i7++) {
                ...
                int k4;
                if (flag1) k4 = aClass29_104.anInt538 + ((aClass29_104.anInt539 - aClass29_104.anInt538) * k7 >> 8);
                else k4 = aClass29_104.anInt538 + ((aClass29_104.anInt539 - aClass29_104.anInt538) * i8 >> 8);
                if ((i3 += 256) >= k4) {
                    i3 = 0;
                    flag1 = !flag1;
                }
    ...
    private int method168(int i, int k, int l) {
        if (l == 1) if ((k & 0x7fff) < 16384) return i;
        else return -i;
